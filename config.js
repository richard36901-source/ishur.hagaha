  ...
  function endpoint(kind) {
    if (USE_PROXY && PROXY_BASE) {
      return PROXY_BASE.replace(/\/$/, '') + ({
        ...
        'client-flags': '/api/client-flags', 'grant-addon': '/api/grant-addon', 'client-active': '/api/client-active', 'guests-reset': '/api/guests-reset', media: '/api/media', 'addon-quote': '/api/addon-quote', 'addon-pay': '/api/addon-pay', human: '/api/human', mediadl: '/api/media-dl', feedback: '/api/feedback', 'guest-add': '/api/guest-add', calendar: '/api/calendar', skip: '/api/skip'
      }[kind] || '/api/event');
    }
    return {
